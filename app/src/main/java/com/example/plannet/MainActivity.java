...
//    private FirebaseConnector db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                ...
                R.id.navigation_events, R.id.navigation_first_time_user, R.id.organizerHashedQrListFragment, R.id.navigation_organizer_create_event, R.id.navigation_entrant_home, R.id.navigation_qr_code_scan)
                .build();
