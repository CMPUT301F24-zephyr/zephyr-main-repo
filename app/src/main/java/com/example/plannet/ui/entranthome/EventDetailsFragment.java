                            ...
                            aVoid -> {
                                ...
                                dbConnector.updateWaitlist(userID, "pending", eventID, eventData,
                                        waitlistSuccess -> {
                                            ...
                                            EntrantNotificationsFragment notificationsFragment = new EntrantNotificationsFragment();
                                            notificationsFragment.queueNotificationForUser(userID, "You have been added to the pending waitlist for the event: " + title.getText().toString());
                                        },
                                        waitlistFailure -> {
